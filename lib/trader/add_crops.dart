...
class AddCrops extends StatefulWidget {
  ...
  AddCrops({required this.traderName});
...
void showAlertDialog(BuildContext context) {
  Widget remindButton = TextButton(
    ...
    child: Text("Ok"),
    onPressed: () {
      Navigator.pushNamed(context, TraderHome.routeName);
    },
  );
